...
contract DaoContract {
    ...
    */
    function _createDAO(string memory _daoName, string memory _targetAudience, string memory _daoDescription, address _multisigAddr) public {
        daoName = _daoName;
    ...
    */
    ...
    function addMember(string memory _email, address   _memberAddr, address _callerAddr,address _daoToJoinMultisig,  Role _role) public onlyOwnerAndRealDao(msg.sender, _daoToJoinMultisig) {
...
//    mapping(address daoMultisigAddr => address[] daoWhiteList) eachDaoToWhiteList;
    ...
    //refactor to private
    function whiteListMember(address _addrToAdd, address _daoMultiSig, address _caller) public onlyOwnerAndRealDao(_caller, _daoMultiSig){
      _caller = msg.sender;
    ...
    function addToBlackList(address _caller, address _memberToBeAdded, address _daoMultiSig) public onlyOwnerAndRealDao(_caller, _daoMultiSig) {
