...
contract TestFullDaoContract is Test {
    ...
    function test_add_member_to_dao_with_valid_inputs() public {
        ...
        fullDaoContract.addMember(
            memberName, emailAddress, phoneNumber, nationalId, role, userAddress, daoMultiSigAddr, multiSigPhoneNo
        );
    ...
    function test_cast_vote_on_valid_proposal_should_update_proposal_votes() public {
        ...
        // Assert
        FullDaoContract.VoteDetails[] memory votes =
            fullDaoContract.getVotes(fullDaoContract.findProposalOwnerByTitle(daoMultiSigAddr, pTitle));
    ...
    function test_retrieve_proposal_by_title() public {
        ...
        // Assert
        FullDaoContract.ProposalDetails memory retrievedProposal =
            fullDaoContract.getProposalByTitle(_daoMultiSigAddr, _pTitle);
