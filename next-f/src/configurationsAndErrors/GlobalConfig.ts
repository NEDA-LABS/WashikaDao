import { createThirdwebClient, getContract, Address } from "thirdweb";
import { celoAlfajoresTestnet} from "thirdweb/chains";
/** typings for celoAlfajoresTestnet --src/44877--17000 for holesky**/
import { useContractRead, useContract } from "@thirdweb-dev/react";


export default function GlobalWalletConfig() {
//@ts-ignore
...
const FULLDAO_CONTRACT_ADDRESS: Address = "0x50d92ea99af339519cd060c73d2db24620af2f57";
  ...
  /**
   * @dev This is the Instance of Our Contract Object that will be available globally
   */
...
const fullDaoContract = getContract({
  client,
  chain,
  address: FULLDAO_CONTRACT_ADDRESS
});
