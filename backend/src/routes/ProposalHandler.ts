...
router.get('/DaoDetails/:multiSigAddr/proposal/:proposalId', authenticator, (req: Request, res: Response) => ProposalController.GetProposalDetailsById(req, res));
//upvoting a proposal
...
router.get('/DaoDetails/:multiSigAddr/proposals', authenticator, (req: Request, res: Response) => ProposalController.GetAllProposalsInDao(req, res));
