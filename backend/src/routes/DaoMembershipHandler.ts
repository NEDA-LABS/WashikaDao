...
/**
    ...
    */
router.post('/AddMember', (req: Request, res: Response) =>  { WhiteListUser(req, res) });//INFO: update member to a certain rank or sth else
/**
    ...
    */
router.post('/BlackListMember', (req: Request, res: Response) => { BlackListMember(req, res)});
/**
